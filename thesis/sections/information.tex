...
\begin{itemize}[noitemsep,nolistsep]
	...
	\begin{itemize}[noitemsep,nolistsep]
		\item The policy can either be deterministic, or stochastic (output is a distribution probebility over actions.)
...
\\
\href{https://www.researchgate.net/publication/338396174_State-of-the-Art_Reinforcement_Learning_Algorithms}{RL - State-of-the-art Reinforcement LEarning Algorithms - 2020}
...
\\
\href{https://proceedings.neurips.cc/paper/2019/hash/07a9d3fed4c5ea6b17e80258dee231fa-Abstract.html}{MARL - ACrit - LIIR - Learning Individual Intrinsic Reward inMulti-Agent Reinforcement Learning - 2019}
\\
...
\\
\href{https://arxiv.org/abs/1706.02275}{MARL - ACrit - Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environment - 2017}
\\
\href{http://proceedings.mlr.press/v97/iqbal19a.html}{MARL - ACrit - Actor-Attention-Critic for Multi-Agent Reinforcement Learning - 2019}
\\
