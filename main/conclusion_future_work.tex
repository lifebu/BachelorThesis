...
% maybe add a small paragraph that talks about that some more experiments would be needed to explore and solidify our findings in more extreme scenarios. like more iterations in observation! especially kNN!

% also some of the architecture parameters that we could additionally test
% Neighbor Aggregation Types, Directed vs Undirected GNN, Node-wise vs Graph-wise Value-function
