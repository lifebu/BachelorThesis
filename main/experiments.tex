...
\begin{figure}[htp]
    \centering
    \subfigure[]{\label{fig:dispersion_example_01}\includegraphics[width=0.32\textwidth]{figures/dispersion_example_01.png}}  
    \subfigure[]{\label{fig:dispersion_example_02}\includegraphics[width=0.32\textwidth]{figures/dispersion_example_02.png}} 
    \subfigure[]{\label{fig:dispersion_example_03}\includegraphics[width=0.32\textwidth]{figures/dispersion_example_03.png}}   
    \hspace{1cm}                       
